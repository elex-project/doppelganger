...
abstract class BaseResultSetWrapper implements java.sql.ResultSet {
	protected java.sql.ResultSet resultSet;

	BaseResultSetWrapper(java.sql.ResultSet resultSet) {
	...
	public Statement getStatement() throws SQLException {
		return new Statement(resultSet.getStatement());
	}
